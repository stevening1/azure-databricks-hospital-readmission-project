...
![Solution Architecture](<solution architecture image here>)
...
![Pipeline](<Lakeflow job image here>)
...
![Star Schema](<star schema image here>)
...
![Dashboard Page 1](<page 1 dashboard image here>)
...
![Dashboard Page 2](<page 2 dashboard image here>)
...
![Dashboard Page 3](<page 3 dashboard image here>)
